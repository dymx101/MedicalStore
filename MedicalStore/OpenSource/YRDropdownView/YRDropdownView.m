                             ...
                             hideAfter:(float)delay
{
    return [YRDropdownView showDropdownInView:view 
                              ...
                              titleLabelColor:[UIColor colorWithWhite:0 alpha:1.0]
...
- (void)layoutSubviews {    
    ...
    if (self.accessoryImage) {
        ...
        accessoryImageView.frame = CGRectMake(self.bounds.origin.x + HORIZONTAL_PADDING, 
                                              (self.bounds.size.height - self.accessoryImage.size.height) / 2,//self.bounds.origin.y + VERTICAL_PADDING,
    ...
    backgroundImageView.backgroundColor = GGSharedColor.orange;
